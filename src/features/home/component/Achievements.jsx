  ...
  return (
    <div className="w-full h-auto bg-[#EEF2F5]">
      <div className="container1 mx-auto py-[4rem]">
        ...
        <p className="text-dark text-center text-[2.5rem] font-bold mt-[1.5rem]">
          أرقام تتحدث
        </p>
        <div className="grid grid-cols-3 gap-x-[4rem] mt-[3rem]">
          {achievementsItems?.map((achievementsItems) => (
            <div className="w-full h-[22rem] p-[3rem] rounded-xl bg-white">
              ...
              <h1 className = "mt-[1.5rem] text-[2.5rem] font-bold text-dark">{achievementsItems?.number}</h1>
              <p className = "text-[#333333] text-[1.2rem] font-bold">{achievementsItems?.title}</p>
              <p className = "text-[#525252] text-[1rem] mt-[2rem]">{achievementsItems?.desc}</p>
            </div>
          ))}
        </div>
      </div>
