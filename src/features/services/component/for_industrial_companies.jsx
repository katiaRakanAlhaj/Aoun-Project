const ForIndustrialCompanies = () => {
  return (
    <div className="w-full h-auto bg-primary py-[6rem]">
      <div className="container2 mx-auto flex flex-col space-y-[1.5rem]">
        <h1 className="text-white text-[1.7rem] font-bold">للشركات الصناعية</h1>
        <p className="text-[#FFFFFF] text-[1.4rem] font-light">
          ضاعف نموك الرقمي وارفع سقف مبيعاتك عبر الانضمام لأكبر تجمع صناعي
          عماني. منصتنا توفر لك الأدوات اللازمة للوصول لأسواق جديدة.
        </p>
